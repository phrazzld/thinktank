...
import { resetVirtualFs, createVirtualFs, addVirtualGitignoreFile } from './virtualFsUtils';
 ...
 * ```
 */
export function setupProjectStructure(basePath: string, files: Record<string, string>): void {
