...
describe('Query Executor', () => {
  ...
  const mockGetProvider = llmRegistry.getProvider as jest.MockedFunction<typeof llmRegistry.getProvider>;
  
  // Mock the configManager
  const mockFindModelGroup = configManager.findModelGroup as jest.MockedFunction<typeof configManager.findModelGroup>;
