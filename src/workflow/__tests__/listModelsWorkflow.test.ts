...
describe('List Models Workflow', () => {
  ...
  beforeEach(() => {
    ...
    (llmRegistry.getProvider as jest.Mock).mockImplementation(
      (providerId: string) => mockProviders[providerId]
    );
