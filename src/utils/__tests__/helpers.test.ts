...
describe('Helper Functions', () => {
  ...
  describe('sanitizeFilename', () => {
    ...
    it('should handle model IDs with special characters', () => {
      expect(sanitizeFilename('openai:gpt-4-turbo-2024-04-09')).toBe(
    ...
    it('should handle special characters that are valid in filenames', () => {
      expect(sanitizeFilename('file-name_with.special+characters!')).toBe(
        'file-name_with.special+characters!'
      );
    });
