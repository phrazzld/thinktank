...
describe('Anthropic Provider', () => {
  ...
  describe('initialization', () => {
    ...
    it('should throw error if API key is missing', async () => {
      ...
      await expect(provider.generate('Test', 'claude-3-opus-20240229')).rejects.toThrow(
  ...
  describe('generate', () => {
    ...
    it('should handle API errors correctly', async () => {
      ...
      // Should still be catchable as AnthropicProviderError for backward compatibility
      await expect(provider.generate('Test prompt', 'claude-3-opus-20240229')).rejects.toThrow(
        AnthropicProviderError
      );
      // But should also be an instance of ApiError from the new system
      await expect(provider.generate('Test prompt', 'claude-3-opus-20240229')).rejects.toThrow(
