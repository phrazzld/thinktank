...
func TestProcessModelsToSynthesis(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			modelNames:            []string{"gpt-5.2", "deepseek-v3.2", "gemini-3-flash"},
			failingModels:         []string{},
		...
		},
		{
			...
			modelNames:            []string{"gpt-5.2", "deepseek-v3.2", "gemini-3-flash", "gemini-3-pro"},
			failingModels:         []string{"deepseek-v3.2", "gemini-3-flash"},
			synthesisModel:        "gpt-5.2",
		...
		},
		{
			...
			modelNames:            []string{"gpt-5.2", "deepseek-v3.2", "gemini-3-flash"},
			failingModels:         []string{"gpt-5.2", "gemini-3-flash"},
